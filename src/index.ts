...
export class MoonPlugin {
   ...
   */
  async saveSettings({ settings, writeSettings }: { settings: MoonPluginSettings, writeSettings: <MoonPluginSettings>({ settings, settingsFileName }: {
    settings: MoonPluginSettings;
   ...
   */
  async integration(props: {markdown: string}) {
